          ...
          <div className="max-w-7xl">
                ...
                <div className="flex items-start mb-6">
                  ...
                  <div>
                    <h2 className="text-4xl lg:text-5xl font-bold text-gray-800 mb-4 leading-tight">
                      Moving the Needle with <span className="text-purple-600">Tech-First Education</span>
                    </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white rounded-2xl p-12 shadow-sm border border-gray-100">
                <div className="text-5xl font-bold text-purple-600 mb-3">45+</div>
                <div className="text-gray-700 font-medium mb-6">Countries Represented</div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="text-5xl font-bold text-purple-600 mb-3">5000+</div>
                <div className="text-gray-700 font-medium mb-6">Successful Graduates</div>
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  <svg
                    className="w-6 h-6 text-purple-600"
                    viewBox="0 0 24 24"
              ...
              {/* Career Success Rate */}
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="text-5xl font-bold text-purple-600 mb-3">83%</div>
                <div className="text-gray-700 font-medium mb-6">Career Success Rate</div>
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  <svg
                    className="w-6 h-6 text-purple-600"
                    viewBox="0 0 24 24"
              ...
              {/* Learner Rating */}
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
                <div className="text-5xl font-bold text-purple-600 mb-3">4.8/5</div>
                <div className="text-gray-700 font-medium mb-6">Learner Rating</div>
                <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
